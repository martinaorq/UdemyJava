...
public class PersonaJDBC {
     ...
     */
    public static int insert(Persona persona) throws SQLException{
     ...
     * @return
     */
    public static int update(Persona persona, int registroACambiar) throws SQLException{
    ...
    public static int delete(int idPersonaABorrar) throws SQLException{
